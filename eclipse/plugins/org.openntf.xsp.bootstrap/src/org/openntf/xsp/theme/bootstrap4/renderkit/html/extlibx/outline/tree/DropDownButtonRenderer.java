 ...
 */
package org.openntf.xsp.theme.bootstrap4.renderkit.html.extlibx.outline.tree;
...
import org.openntf.xsp.theme.bootstrap4.renderkit.html.extlibx.util.NavButtonRenderer;
...
public class DropDownButtonRenderer extends NavButtonRenderer {
    ...
    protected Object getProperty(int prop) {
        switch(prop) {
            case PROP_DROPDOWN_BUTTON_CLASS:   return "btn btn-secondary"; // $NON-NLS-1$
        }
        return null;
    }
