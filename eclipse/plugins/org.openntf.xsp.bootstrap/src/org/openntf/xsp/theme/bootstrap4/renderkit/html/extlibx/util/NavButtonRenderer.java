 ...
 */
package org.openntf.xsp.theme.bootstrap4.renderkit.html.extlibx.util;
 ...
 */
public class NavButtonRenderer extends org.openntf.xsp.theme.bootstrap4.renderkit.html.extlibx.util.NavRenderer {
    ...
    protected String getItemStyleClass(TreeContextImpl tree, boolean enabled, boolean selected) {
        if(tree.getDepth()==2) {
            ...
            return ExtLibUtil.concatStyleClasses("btn", s); // $NON-NLS-1$
        }
