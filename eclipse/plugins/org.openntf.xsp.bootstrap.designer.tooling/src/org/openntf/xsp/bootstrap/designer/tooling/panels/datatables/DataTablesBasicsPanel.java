...
public class DataTablesBasicsPanel extends XSPBasicsPanel {
	...
	public DataTablesBasicsPanel(Composite parent, int style) {
		super(parent, style);
	...
	protected void createGroupBoxContents(Group arg0) {
		...
		GridData data = createControlGDNoWidth(cols);
		createDCCheckboxComputed("showColumnFilters", String.valueOf(true),
