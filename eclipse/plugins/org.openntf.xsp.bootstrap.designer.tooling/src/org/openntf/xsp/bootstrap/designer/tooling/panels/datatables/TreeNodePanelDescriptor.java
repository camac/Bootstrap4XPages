...
public class TreeNodePanelDescriptor {
	...
	final String complexType; // name of the type that contains the property
								// (ex. 'appicationConfiguration')
	final String complexName; // the actual name of the property that is of type
								// 'typeName' (ex. 'configuration')
	final String propertyName; // the links property (in typeName) that this
								// panel is editing
								// (ex.'bannerApplicationLinks').
	...
	/**
	 * utility method for panels that are editing a (links) property of the
	 * "applicationConfiguration" type of the Application Layout.
	 * 
	 * @param configPropName
	 * @return
	 */
	public static TreeNodePanelDescriptor createConfig(String configPropName) {
		return new TreeNodePanelDescriptor(
				EXT_LIB_TAG_APPLICATION_CONFIGURATION,
				EXT_LIB_ATTR_CONFIGURATION, configPropName);
	}
