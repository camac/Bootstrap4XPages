 ...
 *
 */
public class JordWidgetContainerVisualizer extends AbstractCommonControlVisualizer{

    private static final String TITLE_BAR_TEXT = "Jord Title Bar"; // $NLX-WidgetContainerVisualizer.TitleBar-1$
...
//        firstRowSecondCell.addChildTag(imageTag);
        ...
        // Add Toolbar Facet
        Tag toolbarCallbackTag = new Tag(XP_PREFIX, XSPTagNames.XSP_TAG_CALLBACK);
        toolbarCallbackTag.addAttribute(XSPAttributeNames.XSP_ATTR_FACET_NAME, "toolbar");
        firstRowSecondCell.addChildTag(toolbarCallbackTag);        
