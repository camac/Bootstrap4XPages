 ...
 */
package org.openntf.xsp.theme.bootstrap4.renderkit.html.extlibx.containers.tree;
...
public class NavbarLinksRenderer extends NavRenderer {
    ...
    public static final String POSITION_LEFT     = "left"; //$NON-NLS-1$
    public static final String POSITION_RIGHT    = "right"; //$NON-NLS-1$
